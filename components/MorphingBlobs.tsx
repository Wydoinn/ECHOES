...
const MorphingBlobs: React.FC<MorphingBlobsProps> = ({ reducedMotion = false, period = 'night' }) => {
  ...
  useEffect(() => {
    ...
    const blobs = [
      { x: 0.2, y: 0.2, vx: 0.0001, vy: 0.0002, r: 0.6, color: currentPalette[0].color },
      { x: 0.8, y: 0.8, vx: -0.0002, vy: -0.0001, r: 0.7, color: currentPalette[1].color },
      { x: 0.5, y: 0.5, vx: 0.0001, vy: -0.0001, r: 0.5, color: currentPalette[2].color },
      { x: 0.8, y: 0.2, vx: -0.0001, vy: 0.0002, r: 0.45, color: currentPalette[3].color },
      { x: 0.2, y: 0.8, vx: 0.0002, vy: -0.0002, r: 0.55, color: currentPalette[4].color },
    ];
