...
const PortalCard: React.FC<PortalCardProps> = ({ children, onClick, className = '', reducedMotion = false }) => {
  ...
  return (
    <div className="relative group perspective-1000 z-20 w-fit mx-auto">
      {/* 3. Radial Halo Glow (Behind) */}
      <motion.div 
        className="absolute inset-0 bg-purple-500/40 rounded-full blur-[40px] -z-10"
      ...
      >
         ...
         >
            ...
            <motion.div
                ...
                className="relative overflow-hidden bg-[#1a0b2e]/60 backdrop-blur-[24px] border border-white/20 rounded-full px-12 py-5 shadow-[0_0_30px_rgba(139,92,246,0.3)]"
            >
