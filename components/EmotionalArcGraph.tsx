...
import { EmotionalArc, EmotionalSegment } from '../types';
...
const EmotionalArcGraph: React.FC<EmotionalArcGraphProps> = ({ arc, reducedMotion = false }) => {
                    ...
                    {hoveredIndex !== null && (
                         ...
                         >
                             ...
                             <span className="text-white text-sm leading-tight italic">
                                "{points[hoveredIndex].text.substring(0, 50)}{points[hoveredIndex].text.length > 50 ? '...' : ''}"
                             </span>
                         </motion.div>
                    )}
                 </AnimatePresence>
