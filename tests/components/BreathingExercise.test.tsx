  ...
  return {
    motion: {
      div: ({ children, ...props }: React.HTMLProps<HTMLDivElement>) =>
        React.createElement('div', fp(props), children),
      h2: ({ children, ...props }: React.HTMLProps<HTMLHeadingElement>) =>
        React.createElement('h2', fp(props), children),
      span: ({ children, ...props }: React.HTMLProps<HTMLSpanElement>) =>
        React.createElement('span', fp(props), children),
      button: ({ children, ...props }: React.HTMLProps<HTMLButtonElement>) =>
        React.createElement('button', fp(props), children),
      p: ({ children, ...props }: React.HTMLProps<HTMLParagraphElement>) =>
        React.createElement('p', fp(props), children),
    },
