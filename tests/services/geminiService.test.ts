...
describe('GeminiService', () => {
  ...
  describe('generateContent', () => {
    ...
    it('should include responseSchema in proxy request', async () => {
      vi.stubEnv('DEV', false);
      vi.stubEnv('VITE_GEMINI_API_KEY', '');
    ...
    it('should include both responseMimeType and responseSchema together', async () => {
      vi.stubEnv('DEV', false);
      vi.stubEnv('VITE_GEMINI_API_KEY', '');
      ...
      expect(callBody.body.generationConfig.responseMimeType).toBe('application/json');
      expect(callBody.body.generationConfig.responseSchema).toEqual({ type: 'object' });
    });

    it('should handle response with no candidates field', async () => {
      vi.stubEnv('DEV', false);
      vi.stubEnv('VITE_GEMINI_API_KEY', '');
