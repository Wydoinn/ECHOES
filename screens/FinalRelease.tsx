        ...
        {!isReleased ? (
            ...
            >
                ...
                <motion.button 
                    ...
                    className="mb-16 text-[10px] uppercase tracking-widest text-white/30 hover:text-white/80 transition-colors border-b border-transparent hover:border-white/30 pb-1 disabled:opacity-50"
                >
                ...
                >
                    {/* Outer Premium Rings */}
                    <div className="absolute inset-0 rounded-full border border-white/5 scale-100" />
                    <div className="absolute inset-4 rounded-full border border-white/10 scale-100 opacity-50" />
                    <motion.div 
                    ...
                    {/* Central Orb */}
                    <motion.div 
                        className="w-52 h-52 rounded-full flex items-center justify-center relative overflow-hidden shadow-[0_0_80px_rgba(147,51,234,0.15)] backdrop-blur-sm"
                        style={{
                    ...
                    >
                        ...
                        <div className="text-center relative z-10 pointer-events-none">
                            <span className="block text-[9px] uppercase tracking-[0.3em] text-white/40 mb-3">
                                {isHolding ? "Holding..." : "Hold to"}
                            </span>
                            <span className="font-serif-display text-2xl text-transparent bg-clip-text bg-gradient-to-br from-white via-white to-white/60 tracking-[0.2em] drop-shadow-md">
                                RELEASE
                            </span>
                        </div>
                    </motion.div>
                    ...
                    {!reducedMotion && !isHolding && (
                        <div className="absolute inset-8 border border-purple-500/10 rounded-full animate-ping-slow pointer-events-none" />
                    )}
                </div>

                <p className="mt-12 text-white/30 text-[10px] tracking-[0.2em] uppercase">
