...
const RevelationScreen: React.FC<RevelationScreenProps> = ({ result, originalData, onRestart, reducedMotion = false }) => {
  ...
  return (
    <div className="w-full bg-transparent text-white overflow-x-hidden font-sans">
      ...
      <section className="relative min-h-screen z-0 flex flex-col justify-center">
         <VisualMetaphor
         ...
         <motion.div
            ...
            className="absolute bottom-8 md:bottom-10 left-1/2 -translate-x-1/2 flex flex-col items-center space-y-3 pointer-events-none z-10"
         >
