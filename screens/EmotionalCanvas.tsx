...
Output JSON: { "questions": ["...", "...", "..."] }`,
        ...
        if (import.meta.env.DEV) console.error("Prompts failed", err);
    } finally {
        setIsLoadingPrompts(false);
    }
  };
  ...
  const analyzeImage = async (file: File) => {
    ...
    try {
        ...
        if (import.meta.env.DEV) console.error("Image analysis failed", e);
    } finally {
  ...
  const transcribeAudio = async (audioFile: File) => {
    ...
    try {
        ...
        if (import.meta.env.DEV) console.error("Transcription failed", err);
    } finally {
